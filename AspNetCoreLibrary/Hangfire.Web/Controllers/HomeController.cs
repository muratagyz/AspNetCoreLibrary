...
namespace Hangfire.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            FireAndForge.EmailSendToUserJob("1", "Sistemimize hoşgeldiniz");
            return View();
        }
        ...
        public async Task<IActionResult> PictureSave(IFormFile picture)
        {
            ...
            if (picture != null && picture.Length > 0)
            {
                ...
                string jobId = BackgroundJobs.DelayedJobs.AddWaterMarkJob(newFileName, "www.muratagyuz.com");

                BackgroundJobs.ContinuationsJobs.WriteWaterMarkStatus(jobId, newFileName);
            }
            return View();
        }
    }
